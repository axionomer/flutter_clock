...
class _DigitalClockState extends State<DigitalClock> {
      ...
      case WeatherCondition.rainy:
        {
          ...
          loadSvgDrawableRoot(_weatherParticleSvgFile)
              .then((drawable) => setState(() {
                    _weatherColor = Colors.green;
                    _particleColor = Colors.blue;
                    _weatherParticleParameters = ParticleParameters(50,
                        scale: 20,
                        color: _particleColor.withOpacity(.5),
                        svg: drawable);
                    _weatherParticles
                        .updateParameters(_weatherParticleParameters);
                  }));
        }
        break;
      case WeatherCondition.foggy:
        {
          ...
          loadSvgDrawableRoot(_weatherParticleSvgFile)
              .then((drawable) => setState(() {
                    ...
                    _weatherParticleParameters = ParticleParameters(10,
                        scale: 50,
                        color: _particleColor.withOpacity(.5),
                        svg: drawable);
                    _weatherParticles
      ...
      case WeatherCondition.cloudy:
        {
          ...
          loadSvgDrawableRoot(_weatherParticleSvgFile)
              .then((drawable) => setState(() {
                    ...
                    _particleColor = Colors.grey[100];
                    _weatherParticleParameters = ParticleParameters(25,
                        scale: 30,
                        color: _particleColor.withOpacity(.5),
                        svg: drawable);
                    _weatherParticles
      ...
      case WeatherCondition.thunderstorm:
        {
          ...
          loadSvgDrawableRoot(_weatherParticleSvgFile)
              .then((drawable) => setState(() {
                    ...
                    _weatherParticleParameters = ParticleParameters(20,
                        scale: 30,
                        color: _particleColor.withOpacity(.5),
                        svg: drawable);
                    _weatherParticles
  ...
  Widget buildClock(BuildContext context) {
    ...
    List<Color> darkModeColors = [
      TinyColor(textColor).lighten(30).saturate(50).color,
      TinyColor(textColor).darken(10).saturate(50).color
    ];
    List<Color> lightModeColors = [
      TinyColor(textColor).lighten(20).saturate(50).color,
      TinyColor(textColor).darken(20).saturate(50).color
    ];
        ...
        Container(
          ...
          child: Container(
            ...
            child: Stack(children: [
              Align(
                alignment:
                    Alignment(cos(hourAngle - pi / 2), sin(hourAngle - pi / 2)),
                child: Container(
              ...
              Center(
                ...
                gradient: LinearGradient(
                  begin: Alignment(
                      cos(hourAngle - pi / 2), sin(hourAngle - pi / 2)),
                  end: Alignment(
                      cos(hourAngle + pi / 2), sin(hourAngle + pi / 2)),
        ...
        Container(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                begin: Alignment(
                    cos(minuteAngle - pi / 2), sin(minuteAngle - pi / 2)),
                end: Alignment(
                    cos(minuteAngle + pi / 2), sin(minuteAngle + pi / 2)),
                colors: gradientColors,
              ),
            ...
            child: Stack(children: [
              ...
              Align(
                alignment: Alignment(
                    cos(secondAngle - pi / 2), sin(secondAngle - pi / 2)),
                child: Container(
                  width: screenHeight * .03,
                  height: screenHeight * .03,
                  decoration: BoxDecoration(
